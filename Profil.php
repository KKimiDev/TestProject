      ...
      <div class="profile-header">
        ...
        <div>
          <div style="display: flex; align-items: center; gap: 15px;">
            ...
            <button <?php if ($authorisuser) {
                      echo "style='display:none;'";
                    } ?> class="btn btn-sm btn-outline-warning text-black fw-bold rounded-pill px-4">
              Follow
            </button>

            <button <?php if (!$authorisuser) {
                      echo "style='display: none;'";
                    } ?> onclick='window.location.href = "http://localhost/sites/Rezepte/Profilbearbeiten/<?= $profile["Username"] ?>"' class="edit-btn" aria-label="Rezept bearbeiten" title="Rezept bearbeiten">
